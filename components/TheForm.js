    ...
    return (
      	<div>
        	<StyleFormDiv>
        		...
        		<StyledSelect className="select-input"{...field}{...props}></StyledSelect>
          		{meta.touched && meta.error ? (
            	<StyledError className="error">{meta.error}</StyledError>
          		) : null }
        	</StyleFormDiv>
    ...
    return (
		<div>
        	<StyleFormDiv>
          		...
          		<StyleInput className="number-input" {...field}{...props}></StyleInput>
          		{meta.touched && meta.error ? (
            	<StyledError className="error">{meta.error}</StyledError>
          		) : null }
        	</StyleFormDiv>
        	...
        	<div>
        		<StyleDiv>
          			...
          			<Form>       
              			...
              			<StyledButton type="submit">{props.isSubmitting ? 'Saving...' : 'Submit'} </StyledButton>
          			</Form>
        		</StyleDiv>
        	</div>
      	)}
