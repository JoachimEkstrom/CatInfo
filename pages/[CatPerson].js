  ...
  return (
    <div>
      <Div>
        ...
        <TitleText
          style={{ color: `${DataStorage.catPersons[personId].color}` }}
        >
          {DataStorage.catPersons[personId].name}'s Cat infos!
        </TitleText>

        <GetCatInfo
          number={DataStorage.catPersons[personId].number}
        ></GetCatInfo>

        <Link href="/index">
          <Styleda>Back to startpage</Styleda>
        </Link>
      </Div>
    </div>
  );
